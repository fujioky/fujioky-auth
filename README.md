...
A reusable Python package for FastAPI applications using Logto. Version 0.2.3.
...
```sh
pip install "fujioky-auth @ git+https://github.com/fujioky/fujioky-auth.git@v0.2.3"
```
